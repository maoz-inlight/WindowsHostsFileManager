...
- Manage retained isolated-browser data from **More actions → Browser preview data**.
  Inspect profile locations and delete a selected profile after closing all processes for
  that browser. Normal browser profiles are not deleted.
...
Validation: 218 automated tests passed; desktop build and x64/x86/ARM64 packaging succeeded.
